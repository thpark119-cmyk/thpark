...
export default function Metronome() {
  ...
  const [customNumerator, setCustomNumerator] = useState(settings.numerator.toString());
...
${t('metronome.invalidTimeSignatureDesc')}`);
          ...
          <div className="space-y-4 pt-4 border-t border-white/5">
            ...
            <div className={`grid justify-center place-items-center bg-stone-900/50 p-2 sm:p-4 rounded-2xl border border-white/5 gap-1.5 sm:gap-3
              ${settings.numerator === 9 ? 'grid-cols-3 md:grid-cols-9' : 
                settings.numerator === 12 ? 'grid-cols-3 sm:grid-cols-6 lg:grid-cols-12' : 
                settings.numerator === 6 ? 'grid-cols-6' : 
                settings.numerator === 5 ? 'grid-cols-5' : 
                settings.numerator === 4 ? 'grid-cols-4' : 
                settings.numerator === 3 ? 'grid-cols-3' : 
                settings.numerator === 2 ? 'grid-cols-2' : 
                ...
                >
                  <span
                    className={`rounded-full transition-all duration-200 ease-out flex items-center justify-center
                      ...
                      ${state === 'normal' ? 'w-4 h-4 md:w-[18px] md:h-[18px] bg-stone-500/50 border border-stone-500' : ''}
