...
import { Plus, Bookmark, X, Calendar, User, MessageCircle } from 'lucide-react';
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6 pb-12 relative">
      ...
      <div className="space-y-4">
        {logs.map((log) => (
          <div key={log.id} className="bg-bg-card border border-white/5 p-6 rounded-[32px] space-y-5 active:bg-stone-900 transition-colors">
